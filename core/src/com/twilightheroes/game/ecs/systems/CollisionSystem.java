...
public class CollisionSystem extends IteratingSystem {
     ...
     */
    final RenderingSystem renderingSystem;
    /**
     * The MainScreen.
     */
                            ...
                            case TypeComponent.HAZARD:
                                ...
                                if (hazardComponent.alive) {
                                    if (!isHitbox && !player.immune) {
                                        ...
                                        screen.parent.assMan.manager.get("sfx/damage.wav", Sound.class).play();
                                ...
                                if (isInteractHitbox) {
                                    ...
                                    switch (interactiveObjectComponent.tipoObjeto) {
                                        case tipoObjetoInteractivo.LEVER:
                                            ...
                                            screen.parent.assMan.manager.get("sfx/doorOpen.wav", Sound.class).play();
                                            break;
                ...
                if (collidedEntity != null) {
                    ...
                    if (type != null) {
                        if (type.type == TypeComponent.PLAYER) {
                            ...
                            if (!isHitbox && !player.immune && !isInteractHitbox) {
